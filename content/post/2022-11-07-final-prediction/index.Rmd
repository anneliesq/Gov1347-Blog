...
rmse2 <- sqrt(mean(!is.na(data1$actual - data1$fit2)^2))
...
I then do out-of-sample modeling through cross validation. I randomly select 80% to be the train data and the other 20% as the test data. I found that fit 2 had the lowest average mean out-of-sample residual. The histogram for fit 2 also appears the most uniform between the three. Model 1 performed the worst among the three with, with an average mean out-of-sample residual value of 4.896344.
